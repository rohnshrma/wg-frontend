...
const faqs = [
  ...
  { q: "What jobs can I get after completing the course?", a: "Junior Data Analyst (Google, Amazon, Flipkart), Business Analyst (Deloitte, Capgemini), Analytics Associate (PharmEasy, Swiggy), BI Developer (Microsoft, TCS).\n\nSalary range: ₹18–45 LPA depending on background and experience." },
