...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed right-4 sm:right-6 bottom-36 sm:bottom-6 z-40 w-14 h-14 rounded-full bg-[#25D366] shadow-xl flex items-center justify-center hover:scale-110 transition-transform"
    >
