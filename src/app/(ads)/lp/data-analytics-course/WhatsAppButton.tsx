...
// Fixed bottom-right, offset up on mobile so it clears StickyCta's
// bottom-center pill instead of stacking on top of it.
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed right-4 sm:right-6 bottom-24 sm:bottom-6 z-40 w-14 h-14 rounded-full bg-[#25D366] shadow-xl flex items-center justify-center hover:scale-110 transition-transform"
    >
