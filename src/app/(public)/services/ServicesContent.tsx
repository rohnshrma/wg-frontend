        ...
        <div className="flex flex-col gap-4 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto pb-4">
          {serviceDetails.map((service) => (
            ...
            >
              ...
              <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-ink mt-6 mb-6 max-w-2xl leading-[1.05]">
                {service.name}
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
                <div>
                  <h3 className="text-ink font-semibold text-sm uppercase tracking-widest mb-4">
                    What&apos;s included
                  </h3>
                  <ul className="space-y-3">
                    {service.details.map((detail) => (
                      <li key={detail} className="flex items-start gap-3 text-agency-muted">
