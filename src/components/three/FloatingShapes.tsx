...
const FULL_SHAPES: ShapeDef[] = [
  ...
  { position: [5.8, -1.8, -1.5], scale: 1.3, color: "#0EA5E9", geometry: "torusKnot", wireframe: false, speed: 0.8 },
  { position: [4.4, 2.6, -3], scale: 0.7, color: "#EAB308", geometry: "octahedron", wireframe: true, speed: 1.4 },
  { position: [-4.8, -2.4, -2.5], scale: 0.9, color: "#6C3CE1", geometry: "torus", wireframe: false, speed: 1 },
...
const COMPACT_SHAPES: ShapeDef[] = [
  ...
  { position: [4.6, -1.2, -1.5], scale: 0.9, color: "#0EA5E9", geometry: "torusKnot", wireframe: false, speed: 0.8 },
