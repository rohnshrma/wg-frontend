...
export default function GoogleSignInButton({ label }: { label: string }) {
  return (
    <a
      ...
      className="w-full py-3 rounded-xl border border-border bg-white text-text-primary font-semibold shadow-sm hover:bg-gray-50 transition-all flex items-center justify-center gap-2.5"
    >
      <GoogleLogo />
      {label}
    </a>
